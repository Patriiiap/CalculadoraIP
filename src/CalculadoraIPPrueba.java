...
public class CalculadoraIPPrueba {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("---------------------------------------------------------------------------------------");
            System.out.println("Si quieres introducir otra IP escribe 1, si quieres salir escribe 2");
            ...
            do {
                try{
                    ...
                    while (salirInt < 1 || salirInt > 2){
                        System.out.println("Debes introducir 1 o 2, inténtalo de nuevo");
                        salirInt = sc.nextInt();
                    }
